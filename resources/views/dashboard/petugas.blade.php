<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Mobil Disewa</h3>
        <p class="text-3xl font-bold text-red-600">{{ $rentedCars }}</p>
    </div>
    
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Rental Hari Ini</h3>
        <p class="text-3xl font-bold text-purple-600">{{ $todayRentals }}</p>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        ...
        <p class="text-sm text-gray-500 mt-2">Perlu diproses</p>
    </div>
